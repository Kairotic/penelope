...
d = [0.0,0.0,1.0];
rotate ([0,0,45]) {
rotate([0,0,0]) translate([0,0,0*stretch]) yarnSegment(0,a,b,c,d);
rotate([0,0,90]) translate([0,0,-1*stretch]) yarnSegment(90,a,b,c,d);
rotate([0,0,180]) translate([0,0,-2*stretch]) yarnSegment(90,a,b,c,d);
rotate([0,0,270]) translate([0,0,-3*stretch]) yarnSegment(90,a,b,c,d);
rotate([0,0,360]) translate([0,0,-4*stretch]) yarnSegment(90,a,b,c,d);
rotate([0,0,450]) translate([0,0,-5*stretch]) yarnSegment(90,a,b,c,d);
rotate([0,0,540]) translate([0,0,-6*stretch]) yarnSegment(90,a,b,c,d);
