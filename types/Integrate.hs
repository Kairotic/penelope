...
colourTwistOdd (Segment f b S) = colourString f b (tr:[])
colourTwistOdd (Segment f b Z) = colourString f b (tl:[])

colourTwistEven (Segment f b S) = colourString b f (br:[])
colourTwistEven (Segment f b Z) = colourString b f (bl:[])
