...
colourTwistOdd f b S = colourString f b (tl:[])
colourTwistOdd f b Z = colourString f b (tr:[])

colourTwistEven f b S = colourString b f (bl:[])
colourTwistEven f b Z = colourString b f (br:[])
